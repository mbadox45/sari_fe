<script setup>
    ...
    const form = ref({id:null, prioritas:'', })
...
<template>
    <div class="grid">
        ...
        <div class="col-9"><Dropdown v-model="form.prioritas" :options="list_prioritas" optionLabel="name" placeholder="Select a Priority" class="w-full"></Dropdown></div>
        <div class="col-12">
